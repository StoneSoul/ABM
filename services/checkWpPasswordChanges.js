#!/usr/bin/env node
// Las variables de entorno se cargan en `server.js` o mediante el entorno
// de ejecución. Este archivo no debe depender de un `.env` local para
// funcionar correctamente al ser ejecutado desde la aplicación principal.
